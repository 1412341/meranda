<?php
  ...
  $blogs = Blog::getBlogsByCategoryTitle($blog_title, ($page - 1) * 5);
?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <div class="section-title">
              <span class="caption d-block small">Search results</span>
              <h2><?php echo count(Blog::getAllBlogs()) ?> blogs</h2>
            </div>
            <?php
                if (count($blogs) > 0) {
            ...
            ?>
                        <h3>We cannot find your blogs!</h3>
            <?php
                }
            ?>
          </div>
        ...
        <?php
            if (count($blogs) > 0) {
                ...
                $pags = ($numBlogs/5)+1; // 1 blogs per page
        ?>
                <div class="row">
                    <div class="col-lg-6">
                        <ul class="custom-pagination list-unstyled">
                            <?php
                                for ($i = 1; $i < $pags; $i++) {
                                  if ($i == $page) {
                              ?>
                                    <li class="active"><a href="search.php?title=<?php echo $_GET['title'] ?>&page=<?php echo $i ?>"><?php echo $i ?></a></li>
                              <?php
                                  }
                                  else {
                              ?>
                                    <li><a href="search.php?title=<?php echo $_GET['title'] ?>&page=<?php echo $i ?>"><?php echo $i ?></a></li>
                              <?php
                                  }
                              ?>
