      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <form id="postBlog" enctype="multipart/form-data" method="post">
            <input type="text" hidden name="blog_id" value="<?php echo $blogId; ?>">
            <div class="row">
                <div class="form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="blog_slug">Slug: <span class="required">*</span>
                    </label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="text" id="blog_slug" name="blog_slug" class="form-control col-md-7 col-xs-12" disabled value="<?php echo $blogs['slug'];?>">
                      <input type="hidden" id="blog_slug_hidden" name="blog_slug_hidden" class="form-control col-md-7 col-xs-12" value="<?php echo $blogs['slug'];?>">
                  </div>
                </div>
            </div>
            <div class="row">
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="type" id="blog_title" required="required" name="blog_title" class="form-control col-md-7 col-xs-12" value="<?php echo $blogs['title'];?>">
                </div>
              </div>
            </div>
            <br>
            <div class="row">
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="file" id="picture" required="required" name="picture" class="form-control col-md-7 col-xs-12" readonly="readonly"><?php echo $blogs['picture'];?>
                  <input type="text" hidden name="prev_picture" value="<?php echo $blogs['picture'];?>">
                </div>
              </div>
            </div>
            <br>
            ...
            <div class="row">
              <div class="form-group">
                <!-- <div class="col-md-offset-3 col-sm-offset-3"> -->
                  ...
                  <?php
                    $dirPos = strpos($blogs['picture'], 'Pictures');
                    $img = substr($blogs['picture'], $dirPos);
                    $img = './' . $img;
                    $width = getimagesize($blogs['picture'])[0] / 5;
                    $height = getimagesize($blogs['picture'])[1] / 5;
                  ?>
              ...
              <div class="control-group">
                  ...
                  <div class="col-md-3 col-sm-3 col-xs-6">
                      <?php
                        ...
                        $selected_category = Category::getCategoryInBlog($blogs['id']);
                      ?>
                      <select name="category_id" class="form-control col-md-7 col-xs-12">
                          ...
                          ?>
                                    <option value="<?php echo $category['id'] ?>" <?php echo ($category['title'] == $selected_category) ? 'selected' : '' ?>><?php echo $category['title'] ?></option>
                          <?php
                                  }
                              }
                          ?>
            ...
            <br>
            <div id="summernote"><?php echo $blogs['content']; ?></div>
            <div class="row">
              <div class="form-group">
                <div class="col-md-6 col-sm-6 col-xs-12">
...
<!-- newPost -->
<script src="dist/js/updateBlog.js"></script>
