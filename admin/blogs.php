      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="blogs.php"><i class="fa fa-circle-o"></i>All blogs</a></li>
                ...
                <tbody>
                  ...
                  ?>
                      <tr>
                        ...
                        <td><img src="<?php echo $blog['picture'] ?>" width="100"></td>
                        <td><?php echo $blog['title'] ?></td>
                        <td><?php echo $blog['author']?></td>
                        <td><?php echo $blog['date']?></td>
                        <td>
                            <button type="button" class="btn btn-success edit" id="blog<?php echo $blog['id']?>">View</button>
                            <button type="button" class="btn btn-danger delete" id="blog<?php echo $blog['id']?>">Delete</button></td>
                      </tr>
                  <?php
                    }
                  ?>
...
<script src="dist/js/deleteBlog.js"></script>
<script type="text/javascript">
  $(document).ready(function() {
    $('.edit').on('click', function(e) {
      ...
      // if (confirm('Bạn có chắc muốn xóa bài blog này không?')) {
        var blogId = $(this).attr('id').replace("blog", "");

        window.location.href = 'edit-blog.php?id='+blogId;
